...
- [x] **제출 패키지 동결(frozen) 정책 명시** — `6eac233`
  ...
  - 왜: 제출 패키지의 "50개 테스트" 로그가 stale가 아니라 동결본임을 분명히 함(현재 HEAD의 101개와 혼동 방지).
  - 검증: README 내용 확인.
...
- [x] `npm test` 101개 전부 통과(테스트 삭제/스킵 없음)
